 ...
 *
 * <p>These event types correspond to the {@code event_type} field in the Parquet schema. Each type
 * determines which optional fields will be populated in a {@link MatchEvent}.
 *
 * <p>The ordinal values of these enum constants are stored in the Parquet file, so the order should
 * not be changed to maintain backwards compatibility with existing data files.
 */
